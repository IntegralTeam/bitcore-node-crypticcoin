...
var BASE_PACKAGE = {
  description: 'A full CrypticCoin node build with Bitcore',
  repository: 'https://github.com/user/project',
  license: 'MIT',
  readme: 'README.md',
  dependencies: {
    'bitcore-lib-crypticcoin': 'https://github.com/crypticcoinvip/bitcore-lib-crypticcoin.git#sapling',
    'bitcore-node-crypticcoin': 'https://github.com/crypticcoinvip/bitcore-node-crypticcoin.git#sapling'
  }
};
