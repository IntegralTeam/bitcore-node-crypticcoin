...
var BASE_PACKAGE = {
  ...
  readme: 'README.md',
  dependencies: {
    'bitcore-lib-crypticcoin': 'git+ssh://git@git.sfxdx.ru:cryptic/bitcore-lib-crypticcoin.git',
    'bitcore-node-crypticcoin': 'git+ssh://git@git.sfxdx.ru:cryptic/bitcore-node-crypticcoin.git'
  }
};
